...
final class StreamingView: UIView {
    ...
    private let subtitleLabel: UILabel = {
        let label = UILabel()
        label.text = "Выберите трансляцию, к которой вы хотите подключиться, или создайте новую трансляцию."
    ...
    private lazy var createStreamButton: UIButton = {
        ...
        button.setTitle("Создать трансляцию", for: .normal)
...
//        field.leftView = UIImageView(image: .magnifyingGlassIcon)
    ...
    private lazy var emptyView: EmptyStateView = {
        ...
        view.delegate = self
        view.setTitle("Пока нет доступных трансляций \nдля просмотра.")
        return view
    }()
